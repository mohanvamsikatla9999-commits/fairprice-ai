...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-md shadow-primary/25 hover:bg-primary-bright active:scale-[0.98]",
        lime: "cta-lime rounded-xl active:scale-[0.98]",
        outline:
          "border border-border bg-white text-foreground hover:bg-background-muted hover:border-primary/30",
        ...
        soft: "bg-secondary text-primary hover:bg-primary/10",
      },
      size: {
